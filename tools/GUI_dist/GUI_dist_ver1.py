...
class Application(QtWidgets.QMainWindow):
    ...
    def initExpoControl(self):
        ...
        for i in range(1):
            ...
            self.maximumSpinBox.setValue(3)
        ...
        self.minimumSpinBoxs[0].valueChanged.connect(self.CalcCurrentValue)
        self.maximumSpinBoxs[0].valueChanged.connect(self.CalcCurrentValue)
        self.minimumSpinBoxs[0].valueChanged.connect(f0)
        self.maximumSpinBoxs[0].valueChanged.connect(f0)
        self.binSpinBoxs[0].valueChanged.connect(self.slds[0].setMaximum)

        self.slds[0].valueChanged.connect(self.CalcCurrentValue)
#        self.CurrentValue.valueChanged.connect()
        # for updating figure
        self.CurrentValues[0].valueChanged.connect(self.AddDist)
        ...
        ParName = ["tau"]
        for i in range(1):
            self.LineLayout.addWidget(QtWidgets.QLabel(ParName[i]),i+1,0)
    ...
    def initNormControl(self):
        ...
        for i in range(2):
            ...
            if i == 0:
                self.minimumSpinBox.setRange(-100000,100000)
                self.minimumSpinBox.setValue(-5)
            else:
                self.minimumSpinBox.setRange(0,100000)
                self.minimumSpinBox.setValue(1)
            ...
            if i == 0:
                self.maximumSpinBox.setRange(-100000,100000)
                self.maximumSpinBox.setValue(5)
            else:
                self.maximumSpinBox.setRange(0,100000)
                self.maximumSpinBox.setValue(5)
        ...
        self.minimumSpinBoxs[0].valueChanged.connect(f0)
        self.maximumSpinBoxs[0].valueChanged.connect(f0)
        self.binSpinBoxs[0].valueChanged.connect(f0)
        self.slds[0].valueChanged.connect(f0)
        self.minimumSpinBoxs[1].valueChanged.connect(f1)
        self.maximumSpinBoxs[1].valueChanged.connect(f1)
        self.binSpinBoxs[1].valueChanged.connect(f1)
        self.slds[1].valueChanged.connect(f1)
    ...
    def initPoissonControl(self):
        ...
        for i in range(1):
            ...
            # Showing current value         
            self.CurrentValue= QtWidgets.QDoubleSpinBox()
            self.CurrentValue.setRange(0,10000)
